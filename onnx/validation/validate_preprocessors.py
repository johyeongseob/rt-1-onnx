...
"""Save the RT-1 ONNX preprocessing output for one frame."""
...
def _parse_args() -> argparse.Namespace:
  parser = argparse.ArgumentParser(
      description="Run the RT-1 ONNX inference image preprocessing."
  )
  parser.add_argument(
      "--episode-index",
      type=int,
...
def main() -> None:
  ...
  output = preprossors.convert_dtype_and_crop_images(image_batch)
  ...
  print(f"Input dtype: {image_batch.dtype}")
